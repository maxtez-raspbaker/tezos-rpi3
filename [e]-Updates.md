...
***
****04/04/2018****: here is a new precompiled Tezos for the zeronet. In /home/mtzuser just type:
...
By running the script (./tz-switch.sh) it will put the new tezos in its folder (./home/mtzuse/tezos). It will also
create a new tz-start.sh script which does not use the utility cpulimit anymore and it will copy a new config.json file 
in /home/tzuser/.tezos-node (low RAM usage). The content of previous runs stored in /home/tzuser/.tezos/node/store and /home/tzuser/.tezos/node/context is preserved.
***
